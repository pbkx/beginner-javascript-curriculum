...
let favorite_animal = "tiger";
console.log("My favorite animal is", favorite_animal);
...
console.log("My name is", first_name, ", I am", age, "years old, and my favorite color is", favorite_color, ".");